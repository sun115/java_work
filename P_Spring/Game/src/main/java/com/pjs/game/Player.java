...
public class Player {
	...
	public String toTableTagString() {
		...
		tagString = tagString + "<br />";
//		tagString = tagString + "<form class='choose_sec' action='choose' method='post'>"
//				+ "<button>선택</button></form>";
	...
	//jongsun
  	public String toTableDivString(int idx) {
  		String tagString = "";
  		tagString = tagString + "<div class='player"+idx+"'>";
  		tagString = tagString + "<span class='no'>";
  		tagString = tagString + this.idx;
  		tagString = tagString + "</span>";
  		tagString = tagString + "<h3>";
  		...
  		tagString = tagString + this.defenseRate;
  		tagString = tagString + "<br />";
//  		tagString = tagString + "<span>체력 : </span>";
