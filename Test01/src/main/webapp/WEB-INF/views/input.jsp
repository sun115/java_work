...
<body>
	<form action="/test01/input" method="get">
		<span><label>이름</label><input type="text"name="name" /></span>
		<span><label>중간점수</label><input type="number" name="midScore"/></span>
		<span><label>기말점수</label><input type="number" name="finScore"/></span>
